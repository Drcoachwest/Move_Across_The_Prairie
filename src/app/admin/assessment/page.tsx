...
export default function AssessmentPage() {
  ...
  const handleImportFile = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(`Import successful! ${result.results.imported} students imported.`);
      setImportFile(null);
  ...
  const navigateTab = (tab: 'import' | 'enter' | 'view' | 'class-summary') => {
    setActiveTab(tab);
    window.scrollTo(0, 0);
  };
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-4">
            ...
            <span className="text-sm text-gray-500">
              {activeTab === 'import' && '1. Import Students'}
              {activeTab === 'enter' && '2. Enter Test Data'}
              {activeTab === 'view' && '3. View/Edit Tests'}
              {activeTab === 'class-summary' && '4. Class Summary'}
            </span>
          </div>
        ...
        {activeTab === 'import' && (
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-2xl font-bold mb-4">Import Students from CSV</h2>
